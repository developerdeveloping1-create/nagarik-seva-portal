const SERVICES=[
  ...
  {id:'echallan',cat:'transport',icon:'fa-car',col:'#ef4444',ib:'rgba(239,68,68,.12)',title:'e-Challan',pill:'Live',pt:'p-live',desc:'Check and pay your traffic challan online across India.',url:'https://echallan.parivahan.gov.in/index/accused-challan',site:'echallan.parivahan.gov.in'},

  /*BUS PASS */
  {id:'buspass',cat:'bus',icon:'fa-bus',col:'#16a34a',ib:'rgba(22,163,74,.12)',title:'TG Bus Pass',pill:'Live',pt:'p-live',desc:'Apply and manage Telangana RTC bus passes online.',url:'https://www.tgsrtc.telangana.gov.in/bus-pass-services',site:'tgsrtc.telangana.gov.in'},
  {id:'apsrtcpass',cat:'bus',icon:'fa-bus',col:'#0ea5e9',ib:'rgba(14,165,233,.12)',title:'APSRTC Bus Pass',pill:'Live',pt:'p-live',desc:'Apply and manage Andhra Pradesh RTC bus passes online.',url:'https://buspassonline.apsrtconline.in/',site:'buspassonline.apsrtconline.in'},
  ...
  {id:'ayushman',cat:'welfare',icon:'fa-hospital',col:'#ef4444',ib:'rgba(239,68,68,.12)',title:'Ayushman Bharat',pill:'Free',pt:'p-free',desc:'Check eligibility, enroll and get health card for ₹5 Lakh coverage.',url:'https://beneficiary.nha.gov.in/',site:'beneficiary.nha.gov.in'},  {id:'scholarship',cat:'welfare',icon:'fa-graduation-cap',col:'#a78bfa',ib:'rgba(167,139,250,.12)',title:'Scholarships (NSP)',pill:'New',pt:'p-new',desc:'Central & state scholarships for SC/ST/OBC/Minority students.',url:'https://scholarships.gov.in/',site:'scholarships.gov.in'},
  ...
  {id:'apcet',cat:'jobs',icon:'fa-graduation-cap',col:'#6366f1',ib:'rgba(99,102,241,.12)',title:'APSCHE CET Exams',pill:'New',pt:'p-new',desc:'Apply for AP EAMCET, ICET, ECET and other entrance exams conducted by APSCHE.',url:'https://cets.apsche.ap.gov.in/',site:'cets.apsche.ap.gov.in'},
  {id:'appsc',cat:'jobs',icon:'fa-user-tie',col:'#7c3aed',ib:'rgba(124,58,237,.12)',title:'APPSC Jobs',pill:'Live',pt:'p-live',desc:'Apply for government jobs, check notifications, results and hall tickets.',url:'https://portal-psc.ap.gov.in/',site:'portal-psc.ap.gov.in'},
  {id:'tgpsc',cat:'jobs',icon:'fa-briefcase',col:'#0f766e',ib:'rgba(15,118,110,.12)',title:'TGPSC Jobs',pill:'Live',pt:'p-live',desc:'Apply for Telangana government jobs, check notifications, results and hall tickets.',url:'https://www.tgpsc.gov.in/',site:'tgpsc.gov.in'},
...
document.getElementById("mapNote").innerHTML =
  '<i class="fas fa-location-dot"></i> Location not allowed, showing general results';
}
);
